...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.order'
        db.add_column(u'shop_author', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.order'
        db.delete_column(u'shop_author', 'order')
    ...
    models = {
        ...
        u'shop.payment': {
            ...
            'paymentid': ('django.db.models.fields.CharField', [], {'default': '454491386', 'max_length': '20', 'primary_key': 'True'}),
