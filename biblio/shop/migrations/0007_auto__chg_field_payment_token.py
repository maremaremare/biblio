...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.token'
        db.alter_column(u'shop_payment', 'token', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Payment.token'
        db.alter_column(u'shop_payment', 'token', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'shop.payment': {
            ...
            'paymentid': ('django.db.models.fields.CharField', [], {'default': '29208545', 'max_length': '20', 'primary_key': 'True'}),
