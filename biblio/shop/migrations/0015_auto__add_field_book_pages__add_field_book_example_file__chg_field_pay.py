...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_book', 'pages',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Book.example_file'
        db.add_column(u'shop_book', 'example_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Payment.datecreated'
        db.alter_column(u'shop_payment', 'datecreated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Book.pages'
        db.delete_column(u'shop_book', 'pages')

        # Deleting field 'Book.example_file'
        db.delete_column(u'shop_book', 'example_file')


        # Changing field 'Payment.datecreated'
        db.alter_column(u'shop_payment', 'datecreated', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'shop.payment': {
            ...
            'paymentid': ('django.db.models.fields.CharField', [], {'default': '443405907', 'max_length': '20', 'primary_key': 'True'}),
