...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'shop_payment', 'datecreated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True))
    ...
    models = {
        ...
        u'shop.payment': {
            ...
            'paymentid': ('django.db.models.fields.CharField', [], {'default': '6601267', 'max_length': '20', 'primary_key': 'True'}),
