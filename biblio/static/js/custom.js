...
$(document).ready(function() {
    $('ul.cat-list ul').each(function(i) { // Check each submenu:
        if ($.cookie('submenuMark-' + i)) {  // If index of submenu is marked in cookies:
            $(this).show().prev().removeClass('collapsed').addClass('expanded');
            $(this).show().prev().children().first().removeClass('icon-angle-right').addClass('icon-angle-down')
             // Show it (add apropriate classes)
        }else {
        ...
        $(this).prev().addClass('collapsible').click(function() { // Attach an event listener
            var this_i = $('ul.cat-list ul').index($(this).next()); // The index of the submenu of the clicked link
            if ($(this).next().css('display') == 'none') {
                ...
                $(this).parent('li').parent('ul').find('ul').each(function(j) {
                    if (j != this_i) {
                        $(this).slideUp(200, function () {
                            ...
                            cookieDel($('ul.cat-list ul').index($(this)));
                        });
                    }
                });
                // :end
                ...
                $(this).next().slideUp(200, function () { // Hide submenu:
                    ...
                    $(this).find('ul').each(function() {
                        $(this).hide(0, cookieDel($('ul.cat-list ul').index($(this)))).prev().removeClass('expanded').addClass('collapsed');
                    });
                });
            }
